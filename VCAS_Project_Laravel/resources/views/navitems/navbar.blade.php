            ...
            <div class="nav-links">
                <ul>
                   ...
                   @if(Session::get('user')) {{Session::get('user')}} {
                    <li><a class="btn btn-primary" href="{{route('userDash')}}">Dashboard</a></li>
                    <li><a class="btn btn-primary" href="{{route('viewProfile')}}">Profile</a></li>
                    <li><a class="btn btn-primary" href="{{route('editProfile')}}">Edit Profile</a></li>
                    <li><a class="btn btn-primary" href="{{route('changePass')}}">Change Password</a></li>
