              ...
              <MDBRow>
                ...
                <div className="sm='2' bg-light">
                  <ul className="navbar-nav" style={{backgroundColor: "lightblue"}}>
                    ...
                    <li className="nav-item">
                      <a className="nav-link" href="./PendingPDetails">
                    ...
                    <li className="nav-item">
                      <a className="nav-link" href="./SellerDetails">
                        Seller Details
                      </a>
                    </li><br/>
                ...
                <center><h1>Pending Product Details</h1></center>
...
export default PendingPDetails;