...
const CreateBid = () =>{
    ...
    const CreateSubmit= ()=>{
        alert("Your bid is accepted.If you will win, an email will send in your mail with payment details")
        navigate('/mybid');
 ...
 <Navbar2 />
        ...
        <center><h1>Create Bid</h1></center>
...
<div className='input-group mb-3'>
    ...
    <input type="number" className='form-control' name="model" id="model" placeholder='Bid Amount' ></input>
</div>
...
<button type='submit' className="btn btn-primary" onClick={CreateSubmit}>Bid</button>
</div>
<div className="d-grid col-12 mx-auto p-4">
<h1 id='msg'></h1>
</div>
