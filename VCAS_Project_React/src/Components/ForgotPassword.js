        ...
        <MDBCol sm='6'>
          ...
          <div className='d-flex flex-column justify-content-center h-custom-2 w-75 pt-4 h-75'>
           ...
           <br/>
            ...
            <MDBInput wrapperClass='mb-4 mx-5 w-100' value={Otp} onChange={(e)=>setOtp(e.target.value)} placeholder="Please Enter Your Email" id='formControlLg' type='text' size="lg"/>
